(() => {
  ...
  const tableXml = (rows, options = {}) => {
    ...
    const width = Math.floor(5000 / columnCount);
  ...
  const sectionBand = (heading) => `<w:tbl><w:tblPr><w:tblW w:w="5000" w:type="pct"/><w:tblBorders><w:top w:val="single" w:sz="4" w:color="2F75B5"/><w:left w:val="single" w:sz="4" w:color="2F75B5"/><w:bottom w:val="single" w:sz="4" w:color="2F75B5"/><w:right w:val="single" w:sz="4" w:color="2F75B5"/></w:tblBorders></w:tblPr><w:tr><w:trPr><w:cantSplit/><w:trHeight w:val="420" w:hRule="exact"/></w:trPr>${cell(paragraph(heading, "SectionTitle", { color: "FFFFFF", bold: true, after: 0, line: 230 }), { shade: "2F75B5", noBorders: true })}</w:tr></w:tbl>`;
